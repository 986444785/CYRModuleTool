...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CYRModuleTools.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/986444785@qq.com/CYRModuleTools'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '986444785@qq.com' => '986444785@qq.com' }
  s.source           = { :git => 'https://github.com/986444785@qq.com/CYRModuleTools.git', :tag => s.version.to_s }
